...
if (!class_exists('Leadboxer')) {
	class Leadboxer {
		...
		public function register_plugin_scripts() {
			    ...
			    if ( !is_admin() ) {
			    	wp_register_script( 'leadboxerscript', '//script.leadboxer.com/?account=' . $dataset, array(), null, true);
			 		wp_enqueue_script( 'leadboxerscript' );
			    }
		}
		...
		public function add_settings() {
				...
				You will receive an email which contains your dataset.<br>
				...
				<p>You can verify a succesfull install by first visiting the homepage of this Wordpress site, then login at <a href="https://product.leadboxer.com?utm_source=wp-plugin">product.leadboxer.com</a><br>
